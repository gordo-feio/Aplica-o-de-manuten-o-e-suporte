<?php
/**
 * AJAX: Remover Técnico da OS
 * Técnico principal, atendente ou admin podem remover
 */
...
try {
    ...
    $result = $workOrder->removeTechnician($workOrderId, $technicianId, $requesterId);
    ...
    logSystem("Erro no AJAX remove_technician: " . $e->getMessage(), "ERROR");
    jsonResponse([
        'success' => false,
        'message' => 'Erro ao remover técnico. Tente novamente.'
    ], 500);
}
?>